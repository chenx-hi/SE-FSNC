...
class Dataset:
    def __init__(self, name, args):
        ...
        with open("./content/data/split/{}/main_splits.json".format(args.dataset_name), "r") as f:
...
def load_data(dataset, degree_as_tag):
    ...
    if dataset in ['Letter_high', 'ENZYMES', 'Reddit', 'TRIANGLES']:
        ...
        with open('./content/data/datasets/%s/%s.txt' % (dataset, dataset), 'r') as f:
